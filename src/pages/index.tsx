...
export default function Home() {
  ...
  const onClickSearchWeatherByCity = () => {
  ...
  return (
    <div className="flex flex-col gap-4 justify-center items-center">
      ...
      <div className="flex gap-4">
        ...
        <button className="dark:bg-slate-50 dark:text-black px-2 py-1 rounded-sm" onClick={() => { onClickSearchWeatherByCity() } }>Search</button>
      </div>
    </div>
  )
}
